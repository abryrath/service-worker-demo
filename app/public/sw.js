 ...
 * 
 * In order to setup for the Halo test
 * update the targetBlockId to the id of the halo block.
 * Update the 4 video asset links to the non-interactive 
 * hosting for the videos.
*/
